...
public class Fishing {
    private static final Logger logger = LoggerFactory.getLogger(Fishing.class);
    ...
    private static void debugFishingLikelihood() {
        ...
        logger.info("Diary   min " + minhit + " max " + maxhit);
        logger.info("Diary10 min " + minhit10 + " max " + maxhit10);
        logger.info("Hits: " + hits + "Hits10: " + hits10 + " Total: " + total + "   --  %1000: " + (hits * 1000 / total) + ", +10 %1000: " + (hits10 * 1000 / total));
    }
}
