...
public class MapleTrade {
    private static final Logger logger = LoggerFactory.getLogger(MapleTrade.class);
    ...
    public void setMeso(int meso) {
        ...
        if (meso < 0) {
            logger.warn("[Hack] " + chr.getName() + " Trying to trade < 0 mesos");
            return;
        }
        if (chr.getMeso() >= meso) {
            ...
            logger.warn("Not enough mesos:" + meso);
        }
    }
