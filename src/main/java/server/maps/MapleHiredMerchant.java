...
public class MapleHiredMerchant extends AbstractMapleMapObject {
        ...
        synchronized (items) {
            ...
            if (c.getPlayer().getMeso() >= price) {
                if (canBuy(c, newItem)) {
                    ...
                    MapleCharacter owner = WorldServer.getInstance().getWorld(world).getPlayerStorage().getCharacterByName(ownerName);
                    if (owner != null) {
    ...
    private void announceItemSold(Item item, int mesos, int inStore) {
        ...
        MapleCharacter player = WorldServer.getInstance().getWorld(world).getPlayerStorage().getCharacterById(ownerId);
    ...
    public void forceClose() {
        ...
        MapleCharacter owner = WorldServer.getInstance().getWorld(world).getPlayerStorage().getCharacterById(ownerId);
        ...
        WorldServer.getInstance().getWorld(world).unregisterHiredMerchant(this);
