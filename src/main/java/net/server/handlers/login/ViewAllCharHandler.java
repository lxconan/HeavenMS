...
public final class ViewAllCharHandler extends AbstractMaplePacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        try {
            ...
            Pair<Pair<Integer, List<MapleCharacter>>, List<Pair<Integer, List<MapleCharacter>>>> loginBlob = WorldCharacterServer.getInstance().loadAccountCharlist(accountId, c.getVisibleWorlds());
